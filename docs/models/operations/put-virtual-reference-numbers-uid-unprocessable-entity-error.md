...
```typescript
import { PutVirtualReferenceNumbersUidUnprocessableEntityError } from "newline-ts-sdk/models/operations";

let value: PutVirtualReferenceNumbersUidUnprocessableEntityError = {
  code: 1234,

...
```typescript
import { OnboardCustomerProductResponseBody } from "newline-ts-sdk/models/operations";

let value: OnboardCustomerProductResponseBody = {
...
| `status`                                                                                              | [operations.OnboardCustomerProductStatus](../../models/operations/onboard-customer-product-status.md) | :heavy_minus_sign:                                                                                    | the status of the Customer Product onboarding                                                         | active                                                                                                |

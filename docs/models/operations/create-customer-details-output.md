...
```typescript
import { CreateCustomerDetailsOutput } from "newline-ts-sdk/models/operations";

let value: CreateCustomerDetailsOutput = {
  firstName: "Olive",
  middleName: "Olivia",
  lastName: "Oyl",
  suffix: "Jr.",
...
| `address`                                                                                                | [operations.CreateCustomerAddressResponse](../../models/operations/create-customer-address-response.md)  | :heavy_minus_sign:                                                                                       | N/A                                                                                                      |                                                                                                          |
 ...
 */
export function customerProductsOnboard(
  client: NewlineSDKCore,
  request: operations.OnboardCustomerProductRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.OnboardCustomerProductResponse,
    | errors.OnboardCustomerProductUnprocessableEntityError
    | NewlineError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.OnboardCustomerProductRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/customer_products")();
  ...
  const context = {
    ...
    operationID: "onboardCustomerProduct",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.OnboardCustomerProductResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.jsonErr(
      422,
      errors.OnboardCustomerProductUnprocessableEntityError$inboundSchema,
      { hdrs: true },
    ),
    M.fail("4XX"),
    M.fail("5XX"),

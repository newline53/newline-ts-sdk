...
```typescript
import { CreateCustomerDetailsRequest } from "newline-ts-sdk/models/operations";

let value: CreateCustomerDetailsRequest = {
  firstName: "Olive",
  middleName: "Olivia",
  lastName: "Oyl",
  suffix: "Jr.",
...
| `address`                                                                                                | [operations.CreateCustomerAddressRequest](../../models/operations/create-customer-address-request.md)    | :heavy_minus_sign:                                                                                       | N/A                                                                                                      |                                                                                                          |
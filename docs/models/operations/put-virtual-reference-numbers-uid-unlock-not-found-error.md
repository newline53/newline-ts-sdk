...
```typescript
import { PutVirtualReferenceNumbersUidUnlockNotFoundError } from "newline-ts-sdk/models/operations";

let value: PutVirtualReferenceNumbersUidUnlockNotFoundError = {
  code: 1234,

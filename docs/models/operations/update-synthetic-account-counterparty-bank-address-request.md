...
```typescript
import { UpdateSyntheticAccountCounterpartyBankAddressRequest } from "newline-ts-sdk/models/operations";

let value: UpdateSyntheticAccountCounterpartyBankAddressRequest = {
  line1: "123 Abc St.",

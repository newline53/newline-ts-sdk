...
```typescript
import { UpdateCustomerDetailsOutput } from "newline-ts-sdk/models/operations";

let value: UpdateCustomerDetailsOutput = {
  firstName: "Olive",
  middleName: "Olivia",
  lastName: "Oyl",
  suffix: "Jr.",
...
| `address`                                                                                                | [operations.UpdateCustomerAddressResponse](../../models/operations/update-customer-address-response.md)  | :heavy_minus_sign:                                                                                       | N/A                                                                                                      |                                                                                                          |
...
```typescript
import { CreateSyntheticAccountResponse } from "newline-ts-sdk/models/operations";

let value: CreateSyntheticAccountResponse = {
  headers: {
    "key": [],
    "key1": [
      "<value 1>",
...
| `result`                                                                                                           | [operations.CreateSyntheticAccountResponseBody](../../models/operations/create-synthetic-account-response-body.md) | :heavy_check_mark:                                                                                                 | N/A                                                                                                                |
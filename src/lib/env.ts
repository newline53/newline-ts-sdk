...
export interface Env {
  NEWLINE_PROGRAM_UID?: string | undefined;
  NEWLINE_HMAC_KEY?: string | undefined;

  NEWLINE_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodMiniType<Env, unknown> = z.object({
  NEWLINE_PROGRAM_UID: z.optional(z.string()),
  NEWLINE_HMAC_KEY: z.optional(z.string()),

  NEWLINE_DEBUG: z.optional(z.coerce.boolean()),
});

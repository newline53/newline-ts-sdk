...
```typescript
import { UpdateSyntheticAccountCounterpartyBankAddressResponse } from "newline-ts-sdk/models/operations";

let value: UpdateSyntheticAccountCounterpartyBankAddressResponse = {
  line1: "123 Abc St.",

...
```typescript
import { UpdateSyntheticAccountWireCounterpartyAddressResponse } from "newline-ts-sdk/models/operations";

let value: UpdateSyntheticAccountWireCounterpartyAddressResponse = {
  line1: "234 Xyz Rd",
  line2: "APT 5",

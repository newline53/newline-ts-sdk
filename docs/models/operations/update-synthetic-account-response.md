...
```typescript
import { UpdateSyntheticAccountResponse } from "newline-ts-sdk/models/operations";

let value: UpdateSyntheticAccountResponse = {
  headers: {
    "key": [
      "<value 1>",
      "<value 2>",
...
| `result`                                                                                                           | [operations.UpdateSyntheticAccountResponseBody](../../models/operations/update-synthetic-account-response-body.md) | :heavy_check_mark:                                                                                                 | N/A                                                                                                                |
...
```typescript
import { PutVirtualReferenceNumbersUidLockUnprocessableEntityError } from "newline-ts-sdk/models/operations";

let value: PutVirtualReferenceNumbersUidLockUnprocessableEntityError = {
  code: 1234,

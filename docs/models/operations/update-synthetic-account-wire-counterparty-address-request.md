...
```typescript
import { UpdateSyntheticAccountWireCounterpartyAddressRequest } from "newline-ts-sdk/models/operations";

let value: UpdateSyntheticAccountWireCounterpartyAddressRequest = {
  line1: "234 Xyz Rd",
  line2: "APT 5",

...
```typescript
import { CreateSyntheticAccountWireResponse } from "newline-ts-sdk/models/operations";

let value: CreateSyntheticAccountWireResponse = {
  counterpartyAddress: {
    line1: "234 Xyz Rd",
    line2: "APT 5",
...
| `counterpartyBankAddress`                                                                                                                                    | [operations.CreateSyntheticAccountCounterpartyBankAddressResponse](../../models/operations/create-synthetic-account-counterparty-bank-address-response.md)   | :heavy_minus_sign:                                                                                                                                           | Address of the financial institution where the external account is held.<br/>                                                                                |                                                                                                                                                              |

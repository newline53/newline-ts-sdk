...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetTransferRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/transfers/{uid}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetTransferResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail("4XX"),

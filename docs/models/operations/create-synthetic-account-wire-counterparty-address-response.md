...
```typescript
import { CreateSyntheticAccountWireCounterpartyAddressResponse } from "newline-ts-sdk/models/operations";

let value: CreateSyntheticAccountWireCounterpartyAddressResponse = {
  line1: "234 Xyz Rd",
  line2: "APT 5",

...
```typescript
import { GetCustomerProductResponseBody } from "newline-ts-sdk/models/operations";

let value: GetCustomerProductResponseBody = {
...
| `status`                                                                                      | [operations.GetCustomerProductStatus](../../models/operations/get-customer-product-status.md) | :heavy_minus_sign:                                                                            | the status of the Customer Product onboarding                                                 | active                                                                                        |

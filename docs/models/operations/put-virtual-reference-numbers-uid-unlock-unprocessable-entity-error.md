...
```typescript
import { PutVirtualReferenceNumbersUidUnlockUnprocessableEntityError } from "newline-ts-sdk/models/operations";

let value: PutVirtualReferenceNumbersUidUnlockUnprocessableEntityError = {
  code: 1234,

...
```typescript
import { PutTransfersUidCancelResponse } from "newline-ts-sdk/models/operations";

let value: PutTransfersUidCancelResponse = {
  headers: {
    "key": [],
    "key1": [
      "<value 1>",
...
| `result`                                                                                                          | [operations.PutTransfersUidCancelResponseBody](../../models/operations/put-transfers-uid-cancel-response-body.md) | :heavy_check_mark:                                                                                                | N/A                                                                                                               |
...
```typescript
import { SyntheticAccountInstantPayment } from "newline-ts-sdk/models/operations";

let value: SyntheticAccountInstantPayment = {
  counterpartyAddress: {
    streetNumber: "123abc",
    street1: "Abc St.",
    street2: "Suite 4A",
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `counterpartyAddress`                                                                                                                                        | [operations.PostCombinedTransfersInstantPaymentCounterpartyAddress](../../models/operations/post-combined-transfers-instant-payment-counterparty-address.md) | :heavy_check_mark:                                                                                                                                           | Address of the business or individual who owns the external account.<br/>                                                                                    |                                                                                                                                                              |

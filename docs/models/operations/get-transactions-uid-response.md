...
```typescript
import { GetTransactionsUidResponse } from "newline-ts-sdk/models/operations";

let value: GetTransactionsUidResponse = {
  headers: {
    "key": [],
    "key1": [
      "<value 1>",
...
| `result`                                                                                                   | [operations.GetTransactionsUidResponseBody](../../models/operations/get-transactions-uid-response-body.md) | :heavy_check_mark:                                                                                         | N/A                                                                                                        |
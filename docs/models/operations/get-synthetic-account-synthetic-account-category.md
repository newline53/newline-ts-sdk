...
```typescript
import { GetSyntheticAccountSyntheticAccountCategory } from "newline-ts-sdk/models/operations";

let value: GetSyntheticAccountSyntheticAccountCategory = "wire_external";

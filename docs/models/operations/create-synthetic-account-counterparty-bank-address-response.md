...
```typescript
import { CreateSyntheticAccountCounterpartyBankAddressResponse } from "newline-ts-sdk/models/operations";

let value: CreateSyntheticAccountCounterpartyBankAddressResponse = {
  line1: "123 Abc St.",

...
```typescript
import { PutTransactionsUidAuthorizeUnprocessableEntityError } from "newline-ts-sdk/models/operations";

let value: PutTransactionsUidAuthorizeUnprocessableEntityError = {
  code: 1234,

...
```typescript
import { CreateSyntheticAccountCounterpartyBankAddressRequest } from "newline-ts-sdk/models/operations";

let value: CreateSyntheticAccountCounterpartyBankAddressRequest = {
  line1: "123 Abc St.",

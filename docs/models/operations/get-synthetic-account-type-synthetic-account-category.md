...
```typescript
import { GetSyntheticAccountTypeSyntheticAccountCategory } from "newline-ts-sdk/models/operations";

let value: GetSyntheticAccountTypeSyntheticAccountCategory = "wire_external";

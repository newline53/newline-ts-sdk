...
```typescript
import { CreateSyntheticAccountWireCounterpartyAddressRequest } from "newline-ts-sdk/models/operations";

let value: CreateSyntheticAccountWireCounterpartyAddressRequest = {
  line1: "234 Xyz Rd",
  line2: "APT 5",

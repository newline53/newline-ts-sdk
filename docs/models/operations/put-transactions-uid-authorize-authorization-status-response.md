...
```typescript
import { PutTransactionsUidAuthorizeAuthorizationStatusResponse } from "newline-ts-sdk/models/operations";

let value: PutTransactionsUidAuthorizeAuthorizationStatusResponse =
  "client_denied";

...
```typescript
import { CreateSyntheticAccountInstantPaymentCounterpartyAddressResponse } from "newline-ts-sdk/models/operations";

let value: CreateSyntheticAccountInstantPaymentCounterpartyAddressResponse = {
  streetNumber: "123abc",
  street1: "Abc St.",
  street2: "Suite 4A",
  city: "Chicago",
